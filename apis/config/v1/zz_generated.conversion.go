...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*JinliArgs)(nil), (*config.JinliArgs)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1_JinliArgs_To_config_JinliArgs(a.(*JinliArgs), b.(*config.JinliArgs), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*config.JinliArgs)(nil), (*JinliArgs)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_config_JinliArgs_To_v1_JinliArgs(a.(*config.JinliArgs), b.(*JinliArgs), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1_JinliArgs_To_config_JinliArgs(in *JinliArgs, out *config.JinliArgs, s conversion.Scope) error {
	out.Type = config.ScoringStrategyType(in.Type)
	return nil
}

// Convert_v1_JinliArgs_To_config_JinliArgs is an autogenerated conversion function.
func Convert_v1_JinliArgs_To_config_JinliArgs(in *JinliArgs, out *config.JinliArgs, s conversion.Scope) error {
	return autoConvert_v1_JinliArgs_To_config_JinliArgs(in, out, s)
}

func autoConvert_config_JinliArgs_To_v1_JinliArgs(in *config.JinliArgs, out *JinliArgs, s conversion.Scope) error {
	out.Type = ScoringStrategyType(in.Type)
	return nil
}

// Convert_config_JinliArgs_To_v1_JinliArgs is an autogenerated conversion function.
func Convert_config_JinliArgs_To_v1_JinliArgs(in *config.JinliArgs, out *JinliArgs, s conversion.Scope) error {
	return autoConvert_config_JinliArgs_To_v1_JinliArgs(in, out, s)
}
