...
func (c *podGroups) Apply(ctx context.Context, podGroup *schedulingv1alpha1.PodGroupApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.PodGroup, err error) {
	if podGroup == nil {
...
func (c *podGroups) ApplyStatus(ctx context.Context, podGroup *schedulingv1alpha1.PodGroupApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.PodGroup, err error) {
	if podGroup == nil {
		return nil, fmt.Errorf("podGroup provided to Apply must not be nil")
	}
	patchOpts := opts.ToPatchOptions()
